...
public class Note 
{
	...
	//создание записи с указанием текста записи, ее важности, b lfns
	public Note (String noteText, int noteImportance, Date noteDate)
	{
		this.noteText=noteText;//текст записи передается в качестве параметра конструктора
		this.noteImportance=noteImportance;//важность записи передается в качестве параметра конструктора
		this.noteDate=noteDate;//дата выставляется согласно текущей дате
	}
	/*
	 * ___________________
	 * Конструкторы класса
